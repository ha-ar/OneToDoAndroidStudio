...
//        adapterTask = new ArrayAdapter<>(AddTask.this,
...
//        ArrayList<String> arrayListEvent = new ArrayList<String>(Arrays.asList(array));
//
//        final LayoutInflater inflater2 = (LayoutInflater) getApplicationContext()
//                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
...
//        adapterEvent = new ArrayAdapter<>(AddTask.this,
...
//    }
//
//    private void setupMenuSchedule(){
//        final LayoutInflater inflater3 = (LayoutInflater) getApplicationContext()
//                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
...
//        adapterSchedule = new ArrayAdapter<>(AddTask.this,
...
//    }
    ...
    private void AddData() {
        ...
        } else if (Position == 3) { //appointment
        ...
        } else if (Position == 4) { //project
            if (!(aq.id(R.id.project_title).getText().toString().equals(""))) {

                MaxId = App.attach.getInt("5Max", 0);
                titlecheck = 5;
...
//            checklist.setId(f2);
//            checklist.setTitle(checklist_dathnua);
