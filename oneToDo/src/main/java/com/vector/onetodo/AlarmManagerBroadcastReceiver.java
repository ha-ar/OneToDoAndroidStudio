...
public class AlarmManagerBroadcastReceiver extends BroadcastReceiver {
    ...
    public void SetAlarm(@NotNull Context context){
    ...
    public void SetCustAlarm(@NotNull Context context){
        db_initialize();
    ...
    public void CancelAlarm(@NotNull Context context){
        Intent intent = new Intent(context, AlarmManagerBroadcastReceiver.class);
        PendingIntent sender = PendingIntent.getBroadcast(context, 1, intent, 0);
        AlarmManager alarmManager = (AlarmManager) context.getSystemService(Context.ALARM_SERVICE);
        alarmManager.cancel(sender);
    }
    public void setOnetimeTimer(@NotNull Context context){
